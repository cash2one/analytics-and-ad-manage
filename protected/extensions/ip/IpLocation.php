...
class IpLocation
{
	...
	*/
	function ipLocation($datfile = "")
	{
		if($datfile == '')
		{
			$datfile = dirname(__FILE__) . '/IP_2144.dat';
		}
...
/*用法如下:*/
//$ip=new ipLocation("/var/www/html/2144cms/wapadmin/ip/IP_2144.dat");
//$address=$ip->getaddress("203.110.168.225");
//$address=$ip->getaddress("www.baidu.com");
//echo '<pre>';
//print_r($address);

        ...
        <div id="table-content">
                ...
                $columns = array(
                    ...
                    array(
                        ...
                        'type' => 'raw',
                        'filter' => false,
                        'value' => 'User::maxRegister($data["id"])'
                    ));
                $dateColumn = array();
                ...
                $dateColumn[] = array(
                    'header' => date('m-d', $first_time). '至'. date('m-d', $baseTime). '总数',
                    'type' => 'raw',
                    'filter' => false,
                    'value' => 'User::countRegisterByPos($data["id"],' . $first_time . ',' . --$last_time . ')'
                );
                for($i = 6; $i >= 0; $i--)
                {
                    $filter = false;
                    ...
                    $dateColumn[] = array(
                        ...
                        'type' => 'number',
                        'filter' => $filter,
                        'value' => 'User::countRegisterByPos($data["id"],' . $time . ',' . --$nextTime . ')'
                    );
                }
